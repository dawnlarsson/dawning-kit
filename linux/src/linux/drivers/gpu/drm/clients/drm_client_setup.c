...
/*
 * Dawning: the in-kernel compositor lives outside drivers/gpu/drm, and there
 * is no exported way for it to find a DRM device, so it has to be dispatched
 * from here like any other in-kernel client.
 */
