...
//
decimal moonwater_fast_sin(decimal x);

// simpler polynomial error < 0.01
decimal fast_sin(decimal x)
{
        return moonwater_fast_sin(x);
}
#endif // KERNEL_MODE
...
ASM_FUNC(moonwater_positive_to_string)
    ...
    "        jmp     .Lmoonwater_format_test\n"
    ".Lmoonwater_format_step:\n"
    "        inc     %rbp\n"
    "        movzbl  (%rbp), %eax\n"
    ".Lmoonwater_format_test:\n"
    "        test    %al, %al\n"
    "        jz      .Lmoonwater_format_tail\n"
    "        cmp     $37, %al\n"
    "        jne     .Lmoonwater_format_step\n"
    //
    ...
    //
    "        cmp     %rdi, %rbp\n"
    "        je      .Lmoonwater_format_spec\n"
    "        mov     %rbp, %rsi\n"
    "        sub     %rdi, %rsi\n"
    ASM_CALL("rbx")
    ".Lmoonwater_format_spec:\n"
    "        movzbl  1(%rbp), %eax\n"
    "        inc     %rbp\n"
    "        cmp     $115, %al                # s\n"
    "        je      .Lmoonwater_format_string\n"
    "        cmp     $112, %al                # p\n"
    "        je      .Lmoonwater_format_positive\n"
    "        cmp     $98, %al                 # b\n"
    "        je      .Lmoonwater_format_bipolar\n"
#ifndef KERNEL_MODE
    "        cmp     $102, %al                # f\n"
    "        je      .Lmoonwater_format_decimal\n"
#endif
    "        cmp     $37, %al\n"
    "        je      .Lmoonwater_format_literal\n"
    "        test    %al, %al\n"
    "        jz      .Lmoonwater_format_done  # a percent at the end writes nothing more\n"
    ".Lmoonwater_format_next:\n"
    "        movzbl  1(%rbp), %eax\n"
    "        inc     %rbp\n"
    "        mov     %rbp, %rdi\n"
    "        jmp     .Lmoonwater_format_test\n"
    ...
    //
    ".Lmoonwater_format_literal:\n"
    "        mov     %rbp, %rdi\n"
    "        mov     $1, %esi\n"
    ASM_CALL("rbx")
    "        jmp     .Lmoonwater_format_next\n"
    ".Lmoonwater_format_string:\n"
    "        test    %r13, %r13\n"
    "        jns     .Lmoonwater_format_string_stack\n"
    "        mov     160(%rsp,%r13), %rdi\n"
    "        add     $8, %r13\n"
    ".Lmoonwater_format_string_go:\n"
    "        xor     %esi, %esi               # zero length: the writer runs to the terminator\n"
    ASM_CALL("rbx")
    "        jmp     .Lmoonwater_format_next\n"
    ".Lmoonwater_format_positive:\n"
    "        test    %r13, %r13\n"
    "        jns     .Lmoonwater_format_positive_stack\n"
    "        mov     160(%rsp,%r13), %rsi\n"
    "        add     $8, %r13\n"
    ".Lmoonwater_format_positive_go:\n"
    "        mov     %rbx, %rdi\n"
    "        call    moonwater_positive_to_string\n"
    "        jmp     .Lmoonwater_format_next\n"
    //
    ...
    //
    ".Lmoonwater_format_bipolar:\n"
    "        test    %r13, %r13\n"
    "        jns     .Lmoonwater_format_bipolar_stack\n"
    "        movslq  160(%rsp,%r13), %rsi\n"
    "        add     $8, %r13\n"
    ".Lmoonwater_format_bipolar_go:\n"
    "        mov     %rbx, %rdi\n"
    "        call    moonwater_bipolar_to_string\n"
    "        jmp     .Lmoonwater_format_next\n"
#ifndef KERNEL_MODE
    //
    ...
    //       overflow is not.
    //
    ".Lmoonwater_format_decimal:\n"
    "        mov     160(%rsp), %rax\n"
    "        test    %rax, %rax\n"
    "        jns     .Lmoonwater_format_decimal_stack\n"
    "        movsd   128(%rsp,%rax), %xmm0\n"
    "        add     $16, %rax\n"
    "        mov     %rax, 160(%rsp)\n"
    ".Lmoonwater_format_decimal_go:\n"
    "        mov     %rbx, %rdi\n"
    ...
    //
    ".Lmoonwater_format_tail:\n"
    "        mov     %rbp, %rsi\n"
    "        sub     %rdi, %rsi\n"
    ASM_CALL("rbx")
    ".Lmoonwater_format_done:\n"
    "        add     $176, %rsp\n"
    "        pop     %r13\n"
    "        pop     %rbp\n"
    "        pop     %rbx\n"
    ...
    //       of registers first.
    //
    ".Lmoonwater_format_string_stack:\n"
    "        mov     168(%rsp), %rax\n"
    "        mov     (%rax), %rdi\n"
    "        add     $8, %rax\n"
    "        mov     %rax, 168(%rsp)\n"
    "        jmp     .Lmoonwater_format_string_go\n"
    ".Lmoonwater_format_positive_stack:\n"
    "        mov     168(%rsp), %rax\n"
    "        mov     (%rax), %rsi\n"
    "        add     $8, %rax\n"
    "        mov     %rax, 168(%rsp)\n"
    "        jmp     .Lmoonwater_format_positive_go\n"
    ".Lmoonwater_format_bipolar_stack:\n"
    "        mov     168(%rsp), %rax\n"
    "        movslq  (%rax), %rsi\n"
    "        add     $8, %rax\n"
    "        mov     %rax, 168(%rsp)\n"
    "        jmp     .Lmoonwater_format_bipolar_go\n"
#ifndef KERNEL_MODE
    ".Lmoonwater_format_decimal_stack:\n"
    "        mov     168(%rsp), %rax\n"
    "        movsd   (%rax), %xmm0\n"
    "        add     $8, %rax\n"
    "        mov     %rax, 168(%rsp)\n"
    "        jmp     .Lmoonwater_format_decimal_go\n"
#endif
    ASM_END(moonwater_format)
    //
    ...
    //       the definition and the C name is an alias onto it, the way strlen
    //       and strcmp above are their own names.
    //
    "        .globl  string_format\n"
    ...
    //
    //   moonwater_lex_word(source, into, class) -> packed result
    //
...
ASM_FUNC(moonwater_positive_to_string)
    ...
    "        b       .Lmoonwater_format_test\n"
    ".Lmoonwater_format_step:\n"
    "        ldrb    w9, [x20, #1]\n"
    "        add     x20, x20, #1\n"
    ".Lmoonwater_format_test:\n"
    "        cbz     w9, .Lmoonwater_format_tail\n"
    "        cmp     w9, #37\n"
    "        b.ne    .Lmoonwater_format_step\n"
    //
    //       The run of plain text before the percent, if there was one. The C
    //       counted the bytes it had stepped over; the two pointers say the
    //       same thing and cost a register less.
    ...
    "        add     x20, x20, #1\n"
    "        cmp     w9, #115                 // s\n"
    "        b.eq    .Lmoonwater_format_string\n"
    "        cmp     w9, #112                 // p\n"
    "        b.eq    .Lmoonwater_format_positive\n"
    "        cmp     w9, #98                  // b\n"
    "        b.eq    .Lmoonwater_format_bipolar\n"
#ifndef KERNEL_MODE
    "        cmp     w9, #102                 // f\n"
    "        b.eq    .Lmoonwater_format_decimal\n"
#endif
    "        cmp     w9, #37\n"
    "        b.eq    .Lmoonwater_format_literal\n"
    "        cbz     w9, .Lmoonwater_format_done\n"
    ".Lmoonwater_format_next:\n"
    "        ldrb    w9, [x20, #1]\n"
    "        add     x20, x20, #1\n"
    "        mov     x0, x20\n"
    ...
    "        mov     x1, #1\n"
    ASM_CALL("x19")
    "        b       .Lmoonwater_format_next\n"
    ".Lmoonwater_format_string:\n"
    "        cmp     x21, x22\n"
    "        b.hs    .Lmoonwater_format_string_stack\n"
    "        ldr     x0, [x21], #8\n"
    ".Lmoonwater_format_string_go:\n"
    ...
    ".Lmoonwater_format_positive:\n"
    "        cmp     x21, x22\n"
    "        b.hs    .Lmoonwater_format_positive_stack\n"
    "        ldr     x1, [x21], #8\n"
    ".Lmoonwater_format_positive_go:\n"
    "        mov     x0, x19\n"
    "        bl      moonwater_positive_to_string\n"
    "        b       .Lmoonwater_format_next\n"
    //
    //       An int, not a bipolar: the C read one and widened it, and a caller
    //       that passed a negative number in a full register is relying on the
    ...
    ".Lmoonwater_format_bipolar:\n"
    "        cmp     x21, x22\n"
    "        b.hs    .Lmoonwater_format_bipolar_stack\n"
    "        ldrsw   x1, [x21], #8\n"
    ".Lmoonwater_format_bipolar_go:\n"
    "        mov     x0, x19\n"
    "        bl      moonwater_bipolar_to_string\n"
    "        b       .Lmoonwater_format_next\n"
#ifndef KERNEL_MODE
    //
    //       A decimal that ran out of vector registers arrives in eight bytes
    ...
    ".Lmoonwater_format_decimal:\n"
    "        cmn     x23, #48\n"
    "        b.ge    .Lmoonwater_format_decimal_stack\n"
    "        ldr     d0, [x22, x23]\n"
    "        add     x23, x23, #16\n"
    ".Lmoonwater_format_decimal_go:\n"
    "        mov     x0, x19\n"
    ...
    ".Lmoonwater_format_string_stack:\n"
    "        ldr     x0, [x24], #8\n"
    "        b       .Lmoonwater_format_string_go\n"
    ".Lmoonwater_format_positive_stack:\n"
    "        ldr     x1, [x24], #8\n"
    "        b       .Lmoonwater_format_positive_go\n"
    ".Lmoonwater_format_bipolar_stack:\n"
    "        ldrsw   x1, [x24], #8\n"
    "        b       .Lmoonwater_format_bipolar_go\n"
#ifndef KERNEL_MODE
    ".Lmoonwater_format_decimal_stack:\n"
    "        ldr     d0, [x24], #8\n"
    "        b       .Lmoonwater_format_decimal_go\n"
#endif
    ASM_END(moonwater_format)
    //
    //       string_format is the name every caller uses and it cannot be a
...
ASM_FUNC(moonwater_positive_to_string)
    ...
    "        li      t2, 37\n"
    "        j       .Lmoonwater_format_test\n"
    ".Lmoonwater_format_step:\n"
    "        lbu     t0, 1(s1)\n"
    "        addi    s1, s1, 1\n"
    ".Lmoonwater_format_test:\n"
    "        beqz    t0, .Lmoonwater_format_tail\n"
    "        bne     t0, t2, .Lmoonwater_format_step\n"
    //
    //       The run of plain text before the percent, if there was one. The C
    //       counted the bytes it had stepped over; the two pointers say the
    //       same thing and cost a register less.
    //
    "        beq     s1, a0, .Lmoonwater_format_spec\n"
    "        sub     a1, s1, a0\n"
    ASM_CALL("s0")
    ".Lmoonwater_format_spec:\n"
    "        lbu     t0, 1(s1)\n"
    "        addi    s1, s1, 1\n"
    "        li      t1, 115                  # s\n"
    "        beq     t0, t1, .Lmoonwater_format_string\n"
    "        li      t1, 112                  # p\n"
    "        beq     t0, t1, .Lmoonwater_format_positive\n"
    "        li      t1, 98                   # b\n"
    "        beq     t0, t1, .Lmoonwater_format_bipolar\n"
#ifndef KERNEL_MODE
    "        li      t1, 102                  # f\n"
    "        beq     t0, t1, .Lmoonwater_format_decimal\n"
#endif
    "        li      t1, 37\n"
    "        beq     t0, t1, .Lmoonwater_format_literal\n"
    "        beqz    t0, .Lmoonwater_format_done\n"
    ".Lmoonwater_format_next:\n"
...
__asm__(
    ...
    "moonwater_decimal_marks:\n"
    "        .byte   45                      # the three characters written one at a time\n"
    "        .byte   46\n"
    "        .byte   48\n"
    "        .text\n"
    ASM_FUNC(moonwater_fast_sin)
    "        movsd   moonwater_decimal_constants(%rip), %xmm2\n"
    "        movapd  %xmm0, %xmm1            # keep x\n"
    "        divsd   %xmm2, %xmm0\n"
    "        cvttsd2siq %xmm0, %rax\n"
    "        pxor    %xmm0, %xmm0\n"
    "        cvtsi2ssq %rax, %xmm0           # single: PI2 is a float constant\n"
    "        mulss   moonwater_decimal_constants+64(%rip), %xmm0\n"
    "        cvtss2sd %xmm0, %xmm0\n"
    "        subsd   %xmm0, %xmm1\n"
    "        pxor    %xmm0, %xmm0\n"
    ...
    "        jbe     1f\n"
    "        addsd   %xmm2, %xmm1\n"
    "1:      movsd   moonwater_decimal_constants+32(%rip), %xmm0   # sign * 4.0f, folded\n"
    "        movsd   moonwater_decimal_constants+8(%rip), %xmm2    # PI\n"
    "        comisd  %xmm2, %xmm1\n"
    "        jbe     2f\n"
    "        subsd   %xmm2, %xmm1\n"
    "        movsd   moonwater_decimal_constants+40(%rip), %xmm0\n"
    "2:      comisd  moonwater_decimal_constants+16(%rip), %xmm1\n"
    "        jbe     3f\n"
    "        movapd  %xmm2, %xmm4\n"
    "        subsd   %xmm1, %xmm4\n"
    ...
    "        mulsd   %xmm2, %xmm0\n"
    "        divsd   moonwater_decimal_constants+24(%rip), %xmm0\n"
    ASM_RET
    ASM_END(moonwater_fast_sin)
    ...
    //      routine later.
    //
    ASM_FUNC(moonwater_decimal_to_string)
    "        push    %r14\n"
    "        push    %rbx\n"
    "        push    %r12\n"
    "        mov     %rdi, %rbx\n"
    ...
    "        jbe     1f\n"
    "        movq    %xmm0, %r14\n"
    "        lea     moonwater_decimal_marks(%rip), %rdi\n"
    "        mov     $1, %esi\n"
    ASM_CALL("rbx")
    "        movq    %r14, %xmm0\n"
    "        movsd   moonwater_decimal_constants+56(%rip), %xmm1   # xorpd wants 16 aligned\n"
    "        xorpd   %xmm1, %xmm0\n"
    ...
    "        lea     moonwater_decimal_marks+1(%rip), %rdi\n"
    "        mov     $1, %esi\n"
    ASM_CALL("rbx")
    "        movq    %r14, %xmm0\n"
    "        mulsd   moonwater_decimal_constants+48(%rip), %xmm0\n"
    "        cvttsd2siq %xmm0, %r12\n"
    "        cmp     $99999, %r12            # six digits, so leading zeros by hand\n"
    "        jg      8f\n"
    "        lea     moonwater_decimal_marks+2(%rip), %rdi\n"
    "        mov     $1, %esi\n"
    ASM_CALL("rbx")
    "        cmp     $9999, %r12\n"
    "        jg      8f\n"
    ...
    ASM_END(moonwater_decimal_to_string)
);
#elif ARM64
__asm__(
    ...
    "        .text\n"
    ASM_FUNC(moonwater_fast_sin)
    "        adrp    x1, moonwater_decimal_constants\n"
    "        add     x1, x1, :lo12:moonwater_decimal_constants\n"
    ...
    "        stp     x21, x22, [sp, #32]\n"
    "        mov     x19, x0\n"
    "        adrp    x22, moonwater_decimal_marks\n"
    "        add     x22, x22, :lo12:moonwater_decimal_marks\n"
    "        fcmpe   d0, #0.0\n"
    "        b.pl    1f\n"
    "        fmov    x21, d0\n"
    "        mov     x0, x22\n"
    ...
    ASM_CALL("x19")
    "        fmov    d0, x21\n"
    "        adrp    x2, moonwater_decimal_constants\n"
    "        add     x2, x2, :lo12:moonwater_decimal_constants\n"
...
__asm__(
    ...
    "        .text\n"
    ASM_FUNC(moonwater_fast_sin)
    "        lla     t2, moonwater_decimal_constants\n"
    ...
    "        sd      s3, 8(sp)\n"
    "        mv      s0, a0\n"
    "        lla     s3, moonwater_decimal_marks\n"
    "        fmv.d.x ft0, zero\n"
    "        flt.d   t0, fa0, ft0\n"
    "        beqz    t0, 1f\n"
    "        fmv.x.d s2, fa0\n"
...
fn moonwater_decimal_to_string(writer write, decimal value);

fn decimal_to_string(writer write, decimal value)
{
        moonwater_decimal_to_string(write, value);
}
#endif // KERNEL_MODE
...
{
        moonwater_set_cursor(write, pos.x, pos.y);
}
...
bool moonwater_file_valid(file_address source);
fn moonwater_file_new_lazy(file_address result, string_address path, positive flags);
fn moonwater_file_new(file_address result, string_address path, positive flags);
address_any moonwater_file_load(file_address source);
positive moonwater_file_read(file_address source, address_any buffer, positive size, positive offset);
...
__asm__(
    ...
    ASM_RET
    ASM_END(moonwater_file_new_lazy)
...
{
        return moonwater_file_valid(source);
}
...
#else
        moonwater_file_new_lazy(result, path, flags);
#endif
}
...
fn moonwater_file_status(file_address source);
fn moonwater_file_unload(file_address source);
fn moonwater_file_close(file_address source);
positive moonwater_file_write(file_address source, address_any buffer, positive size, positive offset);
...
#else
        moonwater_file_new(result, path, flags);
#endif
}
...
address_any file_load(file_address source)
{
        ...
        return source->data;
#else
        return moonwater_file_load(source);
#endif
}
...
positive file_read(file_address source, address_any buffer, positive size, positive offset)
{
        ...
        return bytes_read;
#else
        return moonwater_file_read(source, buffer, size, offset);
#endif
}
...
#else
        return moonwater_file_write(source, buffer, size, offset);
#endif
}
...
fn moonwater_library_open(file_address storage_location, string_address library_path);
address_any moonwater_library_get(address_any library, string_address name);
fn moonwater_library_close(address_any library);
...
__asm__(
    ...
    //   return through here.
    //
    ASM_FUNC(moonwater_library_open)
    "        mov     %rsi, %rcx\n"
    "1:      movzbl  (%rcx), %eax\n"
    "        test    %al, %al\n"
    ...
    ASM_END(moonwater_library_open)
    //
    ...
    //
    ASM_FUNC(moonwater_library_get)
    "        xor     %eax, %eax\n"
    ASM_RET
    ASM_END(moonwater_library_get)
    ASM_FUNC(moonwater_library_close)
    ASM_RET
    ASM_END(moonwater_library_close)
);
#elif ARM64
__asm__(
    ".text\n"
...
#else
        moonwater_library_open(storage_location, library_path);
#endif
}
...
#else
        return moonwater_library_get(library, name);
#endif
}
...
fn library_close(address_any library)
{
        ...
        FreeLibrary(library);
#else
        moonwater_library_close(library);
#endif
}
...
string_address moonwater_working_directory_get();
fn moonwater_working_directory_set(string_address path);
...
__asm__(
    ...
    //
    "        .text\n"
    ASM_FUNC(moonwater_working_directory_get)
    ...
    ASM_RET
    ASM_END(moonwater_working_directory_get)
    ...
    //
    ASM_FUNC(moonwater_working_directory_set)
    ...
    "        syscall\n"
    ASM_RET
    ASM_END(moonwater_working_directory_set)
);
#elif ARM64
__asm__(
    //
...
#else
        return moonwater_working_directory_get();
#endif
}
...
#else
        moonwater_working_directory_set(path);
#endif
}
...
address_any moonwater_memory(positive size);
fn moonwater_memory_free(address_any address, positive size);
...
__asm__(
    ...
    //
    ASM_FUNC(moonwater_memory_free)
    "        test    %rdi, %rdi\n"
    "        jz      1f\n"
    "        test    %rsi, %rsi\n"
    "        jz      1f\n"
...
#else
        moonwater_memory_free(address, size);
#endif
}
