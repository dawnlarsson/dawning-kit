...
b32 main(void)
{
        ...
        buffered_write_byte((positive)ends[1], buffer, 16, address_of used, '!');
        ...
        buffered_write((positive)ends[1], buffer, 16, address_of used, exact, 16);
        ...
        buffered_write((positive)ends[1], buffer, 16, address_of used,
                       (address_any)"pre", 3);
        buffered_write((positive)ends[1], buffer, 16, address_of used, large, 17);
        ...
        buffered_write_byte((positive)ends[1], buffer, 0, address_of used, '?');
        ...
        buffered_write_deferred_equal((positive)ends[1], buffer, 0,
                                      address_of used, (address_any)"xy", 2);
