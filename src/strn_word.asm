...
#> arch other
#error "this strncmp is the x86_64 catch-up; other architectures have their own"
...
#> arch other
#error "this strnlen is the x86_64 catch-up; other architectures have their own"
