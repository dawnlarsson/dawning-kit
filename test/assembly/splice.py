...
about a line neither of them owns.
    ...
    python3 test/assembly/splice.py <their-copy> <routine> [routine ...]
    python3 test/assembly/splice.py <their-copy> --list        what differs
    python3 test/assembly/splice.py <their-copy> --outside     what they changed that
