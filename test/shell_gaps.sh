...
#
#           sh test/shell_gaps.sh [path-to-moonwater-shell]
#
...
#
#       This is a map and not a test. test/shell.sh and
#       test/shell_compat.sh are the gates: supported behavior belongs in
