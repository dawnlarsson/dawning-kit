...
def misc_checksum(name, variable_length=False):
    options = [Option("-b"), Option("--binary"), Option("-t"), Option("--text"),
               Option("-c"), Option("--check"), Option("--tag"), Option("-z"), Option("--zero"),
               Option("--ignore-missing"), Option("--quiet"), Option("--status"),
               Option("--strict"), Option("-w"), Option("--warn")]
    if variable_length:
        options.append(Option("-l", ("8", "128", "256", "512", "0", "7", "513", "bad"), None))
        options.append(Option("--length", ("256",), True))
    return Utility(
...
UTILITIES = (
    ...
    Utility("dd",
            options=(Option("if=", ("a.txt", "binary", "edge_65537", "empty", "nonl", "missing", "dir",
                     ...
                     Option("conv=", ("sync", "noerror", "fsync", "fdatasync", "lcase", "ucase", "swab",
                                      "notrunc", "excl", "nocreat", "sync,swab", "lcase,ucase", "block",
                                      "unblock", "ascii", "ebcdic", "ibm", "sparse", "", "bad",
                                      "notrunc,sync,noerror"), True),
    ...
    Utility("od",
            options=(Option("-A", ("d", "o", "x", "n", "bad", "dd"), None),
                     ...
                     Option("--format", ("x1z", "c"), True),
                     Option("-j", ("0", "3", "5", "0x3", "1K", "100000", "bad", "-1", "3b"), None),
                     Option("--skip-bytes", ("2",), True),
                     Option("-N", ("0", "1", "5", "16", "17", "33", "65536", "bad", "0x10", "1KiB"), None),
                     Option("--read-bytes", ("7",), True),
                     Option("-w"), Option("-w", ("1", "2", "3", "4", "8", "16", "32", "64", "0", "bad", "5", "6"), True),
                     Option("--width"), Option("--width", ("4", "32", "5", "128"), True),
                     Option("--endian", ("big", "little", "bad"), True),
                     Option("-v"), Option("--output-duplicates"), Option("--address-radix", ("x",), True),
                     Option("-c"), Option("-b"), Option("-o"), Option("-d"), Option("-x"), Option("-s"),
                     Option("-a"), Option("-i"), Option("-l"), Option("-h"), Option("-f"),
                     Option("-S", ("3", "0", "1", "bad"), None), Option("--strings", ("4",), True),
                     Option("--strings"), Option("--traditional")),
    ...
    Utility("hexdump",
            options=(Option("-b"), Option("-c"), Option("-C"), Option("-d"), Option("-o"), Option("-x"),
                     Option("-X"), Option("-v"), Option("--one-byte-octal"), Option("--one-byte-char"),
                     Option("--one-byte-hex"), Option("--canonical"), Option("--two-bytes-decimal"),
                     Option("--two-bytes-octal"), Option("--two-bytes-hex"), Option("--no-squeezing"),
                     Option("-n", ("0", "1", "5", "16", "17", "33", "65536", "1K", "1KiB", "bad"), None),
                     Option("--length", ("5",), True),
                     Option("-s", ("0", "3", "5", "16", "100000", "1KiB", "bad"), None),
                     Option("--skip", ("3",), True),
                     Option("-e", misc_hexdump_formats(), None),
                     Option("--format", ('1/1 "%02x"',), True),
                     Option("-f", ("a.txt", "missing", "empty"), None),
                     Option("-L", ("never", "always", "auto"), True), Option("--color"),
                     Option("--color", ("never",), True)),
    ...
    Utility("diff",
            options=(Option("-u"), Option("-U", ("0", "1", "2", "3", "nope", "-1", "99"), None),
                     ...
                     Option("-i"), Option("--ignore-case"), Option("-w"), Option("--ignore-all-space"),
                     Option("-b"), Option("--ignore-space-change"), Option("-B"), Option("--ignore-blank-lines"),
                     Option("-E"), Option("--ignore-tab-expansion"), Option("-Z"), Option("--ignore-trailing-space"),
                     Option("-r"), Option("--recursive"), Option("-N"), Option("--new-file"),
                     ...
                     Option("-T"), Option("--initial-tab"), Option("-t"), Option("--expand-tabs"),
                     Option("-c"), Option("-C", ("2",), None), Option("--context", ("1",), True), Option("--context"),
                     Option("-e"), Option("--ed"), Option("-n"), Option("--rcs"), Option("-y"), Option("--side-by-side"),
                     Option("-W", ("80",), None), Option("--width", ("60",), True), Option("--left-column"),
                     Option("--suppress-common-lines"), Option("-p"), Option("--show-c-function"),
                     Option("-F", ("^[a-z]",), None), Option("--show-function-line", ("^a",), True),
                     Option("-I", ("alpha",), None), Option("--ignore-matching-lines", ("beta",), True),
                     Option("-x", ("same",), None), Option("--exclude", ("*.txt",), True),
                     Option("-X", ("a.txt",), None), Option("--exclude-from", ("b.txt",), True),
                     Option("-S", ("same",), None), Option("--starting-file", ("differs",), True),
                     Option("--from-file", ("a.txt",), True), Option("--to-file", ("a.txt",), True),
                     Option("-D", ("NAME",), None), Option("--ifdef", ("X",), True),
                     Option("--line-format", ("%l\\n",), True), Option("--old-line-format", ("<%l\\n",), True),
                     Option("-d"), Option("--minimal"), Option("--horizon-lines", ("2",), True),
                     Option("--color", ("never", "always", "auto"), True), Option("--color"),
                     Option("--palette", ("ad=1",), True), Option("--tabsize", ("4",), True),
                     Option("--suppress-blank-empty"), Option("-l"), Option("--paginate"),
                     Option("--ignore-file-name-case"), Option("--no-dereference"), Option("-v")),
    ...
    Utility("cksum",
            options=(Option("-a", ("crc", "crc32b", "md5", "sha1", "sha224", "sha256", "sha384", "sha512",
                                   "blake2b", "sm3", "sha2", "sha3", "bsd", "sysv", "bad", ""), None),
    ...
    Utility("pipesz",
            options=(Option("-g"), Option("--get"), Option("-s", ("4096", "65536", "1M", "0", "bad", "1048576"), None),
                     Option("--set", ("8192",), True), Option("-f", ("a.txt", "dir", "missing", "/dev/null"), None),
                     Option("--file", ("b.txt",), True), Option("-n", ("0", "1", "2", "3", "99", "bad", "-1"), None),
                     Option("--fd", ("0",), True), Option("-i"), Option("--stdin"), Option("-o"), Option("--stdout"),
                     Option("-e"), Option("--stderr"), Option("-c"), Option("--check"), Option("-q"), Option("--quiet"),
                     Option("-v"), Option("--verbose")),
    ...
    Utility("script",
            options=(Option("-c", ("exe a", "exit 3", "printf out; printf err >&2", "cat", "", "echo $0"), None),
                     Option("--command", ("exe b",), True),
                     Option("-e"), Option("--return"), Option("-q"), Option("--quiet"), Option("-f"), Option("--flush"),
                     Option("-a"), Option("--append"),
                     Option("-E", ("auto", "always", "never", "bad"), None), Option("--echo", ("never",), True),
                     Option("-m", ("classic", "advanced", "bad"), None), Option("--logging-format", ("advanced",), True),
                     Option("-O", ("/dev/null",), None), Option("--log-out", ("/dev/null",), True),
                     Option("-I", ("/dev/null",), None), Option("-B", ("/dev/null",), None),
                     Option("--log-io", ("/dev/null",), True), Option("-T", ("/dev/null",), None),
                     Option("--log-timing", ("/dev/null",), True), Option("-t"), Option("--timing", ("/dev/null",), True),
                     Option("--force"), Option("-o", ("1K", "bad"), None), Option("--output-limit", ("1M",), True)),
    ...
    # -- login records --------------------------------------------------------
    Utility("who",
            options=(Option("-a"), Option("--all"), Option("-b"), Option("--boot"), Option("-d"), Option("--dead"),
                     Option("-H"), Option("--heading"), Option("-l"), Option("--login"), Option("-m"), Option("-p"),
                     Option("--process"), Option("-q"), Option("--count"), Option("-r"), Option("--runlevel"),
                     Option("-s"), Option("--short"), Option("-t"), Option("--time"), Option("-T"), Option("-w"),
                     Option("--mesg"), Option("--message"), Option("--writable"), Option("-u"), Option("--users"),
                     Option("--lookup")),
    ...
    Utility("pinky",
            options=(Option("-l"), Option("-b"), Option("-h"), Option("-p"), Option("-s"), Option("-f"), Option("-w"),
                     Option("-i"), Option("-q"), Option("--lookup")),
            operands=((), ("root",), ("nosuchuser",), ("root", "daemon"), ("--", "root")),
            stdin=("empty",), fixture="misc", stderr="loose"),

    Utility("last",
            options=(Option("-a"), Option("--hostlast"), Option("-d"), Option("--dns"), Option("-F"), Option("--fulltimes"),
                     Option("-i"), Option("--ip"), Option("-n", ("0", "1", "2", "3", "100", "bad"), None),
                     Option("--limit", ("2",), True), Option("-R"), Option("--nohostname"), Option("-w"),
                     Option("--fullnames"), Option("-x"), Option("--system"), Option("-T"), Option("--tab-separated"),
                     Option("--time-format", ("notime", "short", "full", "iso", "bad"), True),
                     Option("-p", ("2023-07-22", "now", "bad"), None), Option("--present", ("2023-07-22 05:00",), True),
                     Option("-s", ("2023-07-22", "bad"), None), Option("--since", ("yesterday",), True),
                     Option("-t", ("2023-07-22", "bad"), None), Option("--until", ("2023-07-22 06:00",), True),
                     Option("-3"), Option("-1"), Option("-0")),
    ...
    Utility("logger",
            options=(Option("-i"), Option("--id", ("123", "bad", "0"), True), Option("--id"),
                     Option("-f", ("a.txt", "empty", "missing", "nonl", "dir"), None), Option("--file", ("b.txt",), True),
                     Option("-e"), Option("--skip-empty"), Option("--no-act"),
                     Option("-p", ("user.info", "daemon.err", "local0.debug", "13", "bad", "user.bad", "kern.info",
                                   "info", "0", "191", "192", "user"), None),
                     Option("--priority", ("user.notice",), True), Option("--octet-count"), Option("--prio-prefix"),
                     Option("-s"), Option("--stderr"), Option("-S", ("1", "64", "1024", "1KiB", "bad", "0"), None),
                     Option("--size", ("100",), True), Option("-t", ("tg", "", "a b"), None), Option("--tag", ("tg2",), True),
                     Option("-n", ("localhost", "127.0.0.1"), None), Option("--server", ("localhost",), True),
                     Option("-P", ("1", "514", "bad"), None), Option("--port", ("1",), True),
                     Option("-T"), Option("--tcp"), Option("-d"), Option("--udp"), Option("--rfc3164"),
                     ...
                     Option("--socket", ("/dev/log",), True), Option("--socket-errors", ("on", "off", "auto", "bad"), True),
    ...
    # -- identities -----------------------------------------------------------
    Utility("uuidgen",
            options=(Option("-r"), Option("--random"), Option("-t"), Option("--time"), Option("-6"), Option("--time-v6"),
                     Option("-7"), Option("--time-v7"), Option("-m"), Option("--md5"), Option("-s"), Option("--sha1"),
                     Option("-n", ("@dns", "@url", "@oid", "@x500", "6ba7b810-9dad-11d1-80b4-00c04fd430c8", "bad", "@bad"), None),
                     Option("--namespace", ("@dns",), True),
                     Option("-N", ("www.example.com", "", "deadbeef", "xyz", "two words"), None),
                     Option("--name", ("example",), True), Option("-x"), Option("--hex"),
                     Option("-C", ("0", "1", "3", "bad", "-1"), None), Option("--count", ("2",), True)),
    ...
    Utility("dmesg",
            options=(Option("-F", ("kern.log", "kmsg.log", "a.txt", "empty", "missing", "binary"), None),
                     Option("--file", ("kern.log",), True),
                     Option("-K", ("kmsg.log", "kern.log", "missing"), None), Option("--kmsg-file", ("kmsg.log",), True),
                     Option("-x"), Option("--decode"), Option("-t"), Option("--notime"), Option("-T"), Option("--ctime"),
                     Option("-e"), Option("--reltime"), Option("-d"), Option("--show-delta"), Option("-H"), Option("--human"),
                     Option("-J"), Option("--json"), Option("-k"), Option("--kernel"), Option("-u"), Option("--userspace"),
                     Option("-r"), Option("--raw"),
                     Option("-l", ("err", "warn,info", "err+", "debug", "bad", "emerg,alert,crit,err,warn,notice,info,debug"), None),
                     Option("--level", ("notice",), True),
                     Option("-f", ("kern", "user,daemon", "local7", "bad", "user"), None), Option("--facility", ("daemon",), True),
                     Option("-L", ("never", "always", "auto"), True), Option("--color"), Option("-P"), Option("--nopager"),
                     Option("-p"), Option("--force-prefix"), Option("--noescape"), Option("-S"), Option("--syslog"),
                     Option("-s", ("1", "4096", "0", "bad"), None), Option("--buffer-size", ("8192",), True),
                     Option("-n", ("1", "err", "bad", "8"), None), Option("--console-level", ("warn",), True),
                     Option("-C"), Option("--clear"), Option("-c"), Option("--read-clear"), Option("-D"), Option("--console-off"),
                     Option("-E"), Option("--console-on"),
    ...
    Utility("fincore",
            options=(Option("-J"), Option("--json"), Option("-b"), Option("--bytes"), Option("-n"), Option("--noheadings"),
                     Option("-o", ("RES", "PAGES", "SIZE", "FILE", "RES,FILE", "FILE,SIZE,PAGES,RES", "DIRTY_PAGES",
                                   "res,file", "bad", ""), None),
                     Option("--output", ("SIZE",), True), Option("--output-all"), Option("-r"), Option("--raw"),
                     Option("-c"), Option("--total"), Option("-R"), Option("--recursive"), Option("-C"), Option("--cachestat")),
