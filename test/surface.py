...
list somebody maintains, and each one is run through both.
    ...
    python3 test/surface.py --bin <dir-of-ours>
    python3 test/surface.py --bin <dir> --tool grep
...
test/shell.sh keeps its own list of what it does differently from dash
and why. What this refuses to allow is a divergence nobody has looked at.
"""
import argparse, json, os, re, subprocess, sys, tempfile

HERE = os.path.dirname(os.path.abspath(__file__))
LEDGER = os.path.join(HERE, 'surface_ledger.json')
